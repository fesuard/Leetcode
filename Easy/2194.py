...
# represents the row r2, such that r1 <= r2 and c1 <= c2. Return the list of cells (x, y)
# such that r1 <= x <= r2 and c1 <= y <= c2. The cells should be represented as strings in 
# the format mentioned above and be sorted in non-decreasing order first by columns and then
# by rows.
